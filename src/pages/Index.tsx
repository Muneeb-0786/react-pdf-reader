...
const Index = () => {
  ...
  const handleUploadComplete = async (file: File) => {
    try {
      ...
      setError("There was a problem processing your document. Please try a different PDF file.");
  ...
  return (
    <MainLayout>
      <div className="flex flex-col items-center justify-center h-[calc(100vh-12rem)] max-w-4xl mx-auto">
        <div className="text-center mb-8 animate-slide-down">
          <div className="inline-flex items-center justify-center p-2 bg-primary/10 rounded-full mb-4">
            <FileText className="h-8 w-8 text-primary" />
          </div>
          <h1 className="text-4xl font-bold mb-3 tracking-tight">PDF Reader AI</h1>
        ...
        {error && (
          <Alert variant="destructive" className="mb-4 animate-fade-in w-full max-w-2xl">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Upload your PDF document, and our AI will analyze its content. You can then ask questions about the document and receive intelligent responses based on the text.
              </p>
            </div>
          </div>
        </Card>
